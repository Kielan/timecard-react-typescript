...
const HomeFooterBottomRow = styled.div`
	...
	min-width: 100%;
`
//const HomeFooterBottomRowSection = styled.div`
//	display: flex;
//`
export function AppFooter() {
	return (
      <HomeFooter>
				<HomeFooterTopRow>
					<HomeFooterTopRowSection alt={'LayersIcon'} className={'MenuRightChild'} imageSrc={'/calendaricon.svg'} label={'Shifts'} />
						<HomeFooterTopRowSection alt={'LayersIcon'} className={'FooterTopRowClockImage'} imageSrc={'/clockicon.svg'} label={'Availability'} />
				</HomeFooterTopRow>
				<HomeFooterBottomRow>
...
const HomeFooterTopRowSectionSpan = styled.span`
	...
	font-size: 1.3rem;
`
function HomeFooterTopRowSection({ alt, className, imageSrc, label }) {
	return (
...
const HomeFooterBottomRowSectionSpan = styled.span`
	...
	margin-bottom: 1rem;
`
function HomeFooterBottomRowSection({ alt, className, imageSrc, label }) {
	return (
